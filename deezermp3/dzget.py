...
if __name__ == "__main__":
    ...
    parser.add_argument('-f',
                        ...
                        default='best',
                        type=str,
                        help='Specify audio format: "best", "aac", "flac", "mp3", "m4a", "opus", "vorbis", or "wav" (default "best")')
    ...
    parser.add_argument('-q',
                        ...
                        default='5',
                        type=str,
                        help='Specify ffmpeg/avconv audio quality, insert a value between 0 (better) and 9 (worse) for VBR or a specific bitrate like 128K (default 5)')
    ...
    if args.audio_format:
        if args.audio_format not in ['best', 'aac', 'flac', 'mp3', 'm4a', 'opus', 'vorbis', 'wav']:
